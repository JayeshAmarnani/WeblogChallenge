...
-----Instead of Max(c.ip) in below query , it can also be written as - FLATTEN(SUBSTRING(BagToString(c.ip),0,INDEXOF(c.ip,"_",1)))
...
STORE ds_final INTO 'Sessionized_dump_fulldata';
...
STORE ds_avg_session INTO 'Average_Session_Time_fulldata';
...
STORE ds_unique_url INTO 'Unique_Url_Session_fulldata';
...
STORE ds_final_top INTO 'Max_Users_Session_fulldata';
